...
+(BOOL)isAnIPod{
    ...
    if(
          [DeviceUtil hardware] == IPOD_TOUCH_1G ||
          [DeviceUtil hardware] == IPOD_TOUCH_2G ||
          [DeviceUtil hardware] == IPOD_TOUCH_3G ||
          [DeviceUtil hardware] == IPOD_TOUCH_4G ||
          [DeviceUtil hardware] == IPOD_TOUCH_5G
       ){
        return YES;
    }
    return NO;
